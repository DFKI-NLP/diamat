...
If the lfs download fails, download diamat/data/output.zip (and other files) from [here](https://drive.google.com/drive/folders/1N2jXo1z_B6xcDnogcVIL4yl3LhVILrrd).
